...
function setBMSCalculatedValues(data){
    ...
    if((data.energyUsed.ch1 / 1000) < 200){           // 0 to 199.999Wh
        ...
        setValueTexts(bmsCh1EnergyUsedValues, (data.energyUsed.ch1 / 1000000).toFixed(1) + "kWh");
    }
    ...
    if((data.energyUsed.ch2 / 1000 < 200)){           // 0 to 199.999Wh
        ...
        setValueTexts(bmsCh2EnergyUsedValues, (data.energyUsed.ch2 / 1000000).toFixed(1) + "kWh");
    }
    ...
    if((data.energyUsed.ch3 / 1000 < 200)){           // 0 to 199.999Wh
        ...
        setValueTexts(bmsCh3EnergyUsedValues, (data.energyUsed.ch3 / 1000000).toFixed(1) + "kWh");
    }
